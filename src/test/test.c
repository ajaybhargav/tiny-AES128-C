...
static void test_encrypt_cbc_inplace(void);
static void test_decrypt_cbc_inplace(void);
...
int main(void)
{
    test_encrypt_cbc();
    test_decrypt_cbc();
    test_encrypt_cbc_inplace();
    test_decrypt_cbc_inplace();
    test_decrypt_ecb();
    test_encrypt_ecb();
...
static void test_decrypt_cbc_inplace(void)
{
  ...
  aes_t aes;
  AES128_CBC_decrypt_inplace(&aes, in, 64, key, iv);

  printf("CBC decrypt inplace: ");
...
static void test_encrypt_cbc_inplace(void)
{
  ...
  aes_t aes;
  AES128_CBC_encrypt_inplace(&aes, in, 64, key, iv);

  printf("CBC encrypt inplace: ");
